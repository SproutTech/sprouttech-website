	...
	<div class="container-fluid">
			...
			<div class="menu">
				...
				<ul>
					...
					<li><a href="portfolio"><button class="btn btn-default "
								id="menuBtn" style="border: 1px white solid;">Portfolio</button></a></li>
		...
		<div class=" row ourWorkSection">
			...
			<div class="row pageSummary">Check out our latest work in
				web/mobile app design and development.</div>
			<div class="row workContainer">

				<c:forEach items="${projects}" var="project">

					<div class="col-md-6 nopadding  project"
						style="background-image: url(<c:out value="${project.imagePath}"/>)">
						<div class="greenLayer">
							<div class="projectHeader">
								${project.projectName}<br>
								<br>
								<div class="projectSummary">${project.summary}</div>
								<br> <a href="<c:out value="${project.url}"/>"
									target="_blank"><button class="btn btn-default"
										id="menuBtn" style="border: 1px solid white">View
										Project</button></a>
							</div>
						</div>
					</div>
